...
public class TeacherDaoImpl implements TeacherDao {
	...
	public void addTeacher(Teacher teacher) {
		...
		template.update(sql, teacher.getTeacherName(), teacher.getDateOfBirth(), teacher.getGender(),
				teacher.getAddress(), teacher.getContactNumber(), teacher.getJoiningDate(), teacher.getUsername());
	}
	...
	public Teacher findByUsername(String username) {
		...
		try {
			return (Teacher) template.queryForObject(sql, new Object[] { username },
	...
	public Teacher findById(int teacherId) {
		...
		try {
			return (Teacher) template.queryForObject(sql, new Object[] { teacherId },
					new BeanPropertyRowMapper<>(Teacher.class));
		} catch (Exception e) {
			return null;
		}
