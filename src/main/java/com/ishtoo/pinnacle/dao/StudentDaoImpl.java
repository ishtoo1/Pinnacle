...
public class StudentDaoImpl implements StudentDao {
	...
	public void addStudent(Student student) {
		...
		template.update(sql, student.getStudentName(), student.getDateOfBirth(), student.getGender(),
				student.getAddress(), student.getContactNumber(), student.getBatchId(), student.getUsername());
	}
	...
	public Student findByUsername(String username) {
		...
		try {
			return (Student) template.queryForObject(sql, new Object[] { username },
