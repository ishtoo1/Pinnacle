...
public class SubjectDaoImpl implements SubjectDao {
	...
	public void addSubject(Subject subject) {
		...
		template.update(sql, subject.getSubjectId(), subject.getSubjectName(), subject.getBatchId(),
	...
	public Subject findSubjectById(String batchId, String subjectId) {
		...
		try {
			return (Subject) template.queryForObject(sql, new Object[] { batchId, subjectId },
