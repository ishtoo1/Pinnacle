...
<body>
	...
	<div class="form-container">
		<div class="form">
			<form-title>
			<center>Test Addition</center>
			</form-title>
			<form class="form-registration" action="" method="post" name="form">
				<label for="testName">Test Name</label> <input class="form-styling"
					type="text" id="testName" name="testName" maxlength="40"
					required="required"><br> <label for="testDate">Test
					Date</label> <input class="form-styling" type="date" id="testDate"
