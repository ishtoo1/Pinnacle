...
<body>
	...
	<form action="" method="post">
	  ...
	  <input type="text" id="testName" name="testName" maxlength="40" required="required"><br>
	  <label for="testDate">Test Date:</label><br>
	  <input type="date" id="testDate" name="testDate" required="required"><br>
	  <label for="totalMarks">Total Marks:</label><br>
	  <input type="number" id="totalMarks" name="totalMarks" min="0" max="1000" required="required"><br>
