...
<title>Delete Test from Batch</title>
</head>
<body>
	...
	<form action="" method="post">
	  ...
	  <select id="testId" name="testId" required="required">
	  	<option value="">Choose a Test to delete</option>
	    <c:forEach var="test" items="${allTestsInThisBatch}">
	...
	$ (document).ready(function(){
	    function testSelectOnChange() {
	        ...
	        var data = {};
	        var url = "/admin/findTestsInThisBatch/" + batchId;
	        console.log(url);
	        $.ajax({
	            url: url,
	            type: "post",
	            ...
	            success: function (data, status, xhr) {
	                ...
	                $('#testId').append('<option value="">Choose a Test to delete</option>');
	                console.log(data);
