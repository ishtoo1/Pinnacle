...
<body>
	...
	<form action="" method="post">
	  ...
	  <br>
	  <label for="lectureName">Lecture Name:</label><br>
	  <input type="text" id="lectureName" name="lectureName" maxlength="40" required="required"><br>
	...
	$ (document).ready(function(){
	    function batchSelectOnChange() {
	        ...
	        var data = {};
	        var url = "/teacher/changeSubjectInit/" + batchId;
	        console.log(url);
	        $.ajax({
	            url: url,
	            type: "post",
