		        ...
		        <nav class="navbar navbar-inverse navbar-static-top">
		             <div class="navbar-header">
			              ...
			              <div class="" data-wow-delay="">
			                    <a class="navbar-brand" href="/"><img src="/images/logo-2.png" width="200" height="66.4"></a>
			              </div>
			          </div>
		               ...
		               <li><a href="/">Home</a></li>
						...
						<c:if test="${len>0}">
							<c:if test="${roleStr == 'ROLE_admin'}">
								...
								<li><a style="color:#009c9e;" href="/admin/profile/${userStr}">${userStr}</a></li>
								<li><a href="/logout">Logout</a></li>
							</c:if>
							<c:if test="${roleStr == 'ROLE_teacher'}">
								<li><a href="/welcome">Function</a></li>
								<li><a style="color:#009c9e;" href="/teacher/profile/${userStr}">${userStr}</a></li>
								<li><a href="/logout">Logout</a></li>
							</c:if>
							<c:if test="${roleStr == 'ROLE_student'}">
								<li><a href="/welcome">Function</a></li>
								<li><a style="color:#009c9e;" href="/student/profile/${userStr}">${userStr}</a></li>
								<li><a href="/logout">Logout</a></li>
							</c:if>
						</c:if>
						<c:if test="${len==0}">
